            ...
            {filteredClasses.length === 0 ? (
              ...
              <div className="space-y-4">
                {filteredClasses.map((cls) => (
                  <div key={cls.id} className="bg-white rounded-lg border border-[#d1dde6] overflow-hidden">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <ul className="space-y-2">
                            ...
                            {/* <li className="flex items-center text-sm text-[#507a95]">
                              <Clock className="h-4 w-4 text-[#1d8cd7] mr-2" />
                              {formatScheduleTime(cls.schedule)}
                            </li> */}
                            {/* <li className="flex items-center text-sm text-[#507a95]">
                        ...
                        <div>
                          ...
                          <div className="mb-2">
                            <div className="flex justify-between items-center text-xs text-[#507a95] mb-1">
                              ...
                              {/* <span>{cls.progressPercentage}% Complete</span> */}
                            </div>
                          ...
                          {/* <p className="text-xs text-[#507a95]">
                            Next assignment due: {cls.nextAssignment.name} - {cls.nextAssignment.dueDate}
                          </p> */}
                        </div>
                      </div>
                    </div>
